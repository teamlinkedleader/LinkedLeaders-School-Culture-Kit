...
be_word: BE Visible
lane: Leader
title: Design Your Pre-Service Week (August)
promise: An opening week that starts with people and still gets the compliance done.
time_display: 25 minutes
time_minutes: 25
cost: $0
leaves_behind: A drafted pre-service agenda with a people-first first morning and a compliance checklist with a deadline.
leader_goes_first: true
source: built-2026-07-24
---
# Culture Builder: Design Your Pre-Service Week (August)

An opening week that starts with people and still gets the compliance done.

## Objective

Rebuild your pre-service agenda so the first thing staff experience is each other, not a password reset. The working rule: nothing in the first morning that could have been an email. Staff will remember the first ninety minutes of the year for the next ten months, and they will read it as a statement about what you actually value.

## Time Needed

25 minutes for the draft. You will refine it later, but the shape gets set here.
...
5. **Protect classroom time (3 minutes).** Count the unstructured hours you are giving teachers in their own rooms. If it is less than half a day, go back and cut something of yours. Room time is the single most requested and least granted thing in pre-service week.
