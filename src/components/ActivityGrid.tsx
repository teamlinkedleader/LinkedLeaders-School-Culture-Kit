        ...
        {!unlocked && (
          <div className="mb-10 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 p-6 md:p-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-3">
              <Lock className="w-6 h-6 text-blue-100" />
              <h3 className="text-xl font-bold text-white">52 Activities Locked</h3>
            </div>
            <p className="text-blue-100 mb-5 max-w-xl mx-auto">
              Subscribe to receive one activity per week for 52 weeks — and unlock
              the full collection instantly.
            </p>
            <button
